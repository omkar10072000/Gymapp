...
class ChildWidget extends StatefulWidget {
  ...
  String we;
  String level;
  ChildWidget({Key key, this.number, this.we, this.level}) : super(key: key);
...
class _ChildWidgetState extends State<ChildWidget> {
  ...
  int index = 0;
  List<name> l = [
    name("Plank taps", "50 sec"),
    name("Incline Push ups", "15 Rep"),
    name("Hower push ups", "15 Rep"),
    name("Pull ups", "15 Rep"),
    name("Hindu push up", "15 Rep"),
    name("Decline push up", "15 Rep"),
    name("Crossover crunch", "15 Rep"),
    name("Heel touch", "15 Rep"),
    name("Squats", "15 Rep"),
    name("Lunges", "15 Rep"),
    name("Crossover crunch", "15 Rep"),
    name("Heel touch", "15 Rep")
